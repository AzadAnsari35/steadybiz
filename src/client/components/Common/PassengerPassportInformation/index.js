...
const PassengerPassportInformation = (props) => {
  ...
  const [showPassportDetails, setShowPassportDetails] = useState(
  ...
  return (
    <div className="PassengerPassportInformation">
      <div
        className="PassengerPassportInformation-title d-flex cursor-pointer"
        onClick={togglePassportDetails}
      >
        <Text
          className="font-primary-medium-16"
          text="Add Passport and Frequent Flyer Details"
        />

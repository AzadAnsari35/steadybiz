...
const Footer = () => {
  return (
    <div className="Footer d-flex justify-content-between  align-items-center p-12 font-primary-medium-14">
      ...
      <div className="font-primary-regular-16">
        Design &amp; Developed By:{' '}
        <a
          className="link-text  text-decoration-none"
          href="https://steadybiz.in/"
        >
          Steadybiz
        </a>
      </div>

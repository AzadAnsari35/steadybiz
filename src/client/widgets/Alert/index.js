...
const Alert = (props) => {
  ...
  return (
    <div className={`alert box-shadow-primary ${!!danger ? 'danger' : 'success'} ${!!className ? className : ''}`}>
      <div className={`alert-border ${!!danger ? 'danger' : 'success'}`} />
      <div className="alert-content">
        <div className="alert-content__text d-flex">
          <div className={`icon ${!!danger ? 'danger' : 'success'} d-flex justify-content-center align-items-center`}>
